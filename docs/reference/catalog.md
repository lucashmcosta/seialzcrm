...
| integrations/nammux | [`integrations/nammux/`](../integrations/nammux/README.md) | external_mappings (compart.), nammux_process_snapshots, nammux_sync_events, v_entity_sync_status | nammux-* | sync_nammux_subscription, emit_nammux_post_win_document; fn_sync_nammux_subscription, fn_build_opportunity_won_payload |
| integrations/suvsign | [`integrations/suvsign/`](../integrations/suvsign/README.md) | documents (compart.), document_types | suvsign-webhook | emit_nammux_post_win_document (compart.) |
