...
We process data received through Meta's APIs and products ("**Platform Data**") in strict compliance with the [Meta Platform Terms](https://developers.facebook.com/terms/) and Meta's Developer Policies, as well as the [WhatsApp Business Solution Terms](https://www.whatsapp.com/legal/business-solution-terms). Specifically:
