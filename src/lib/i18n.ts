export const translations = {
  'pt-BR': {
    ...
    'dashboard.entered': 'Criadas',
    'dashboard.closed': 'Ganhas',
    ...
    'tasks.typeFolderCreation': 'Criação de pasta',
    'tasks.typeInitial': 'Inicial',
    'tasks.typeCorrection': 'Correção',
    'tasks.typeDistribution': 'Distribuição',
    'tasks.typeCall': 'Ligação',
    'tasks.typeMessage': 'Mensagem',
    'tasks.typeReminder': 'Lembrete',
    'tasks.typeFollowUp': 'Follow-up',
    'tasks.viewList': 'Lista',
    'tasks.viewKanban': 'Kanban',
    'tasks.columnOverdue': 'Atrasadas',
    'tasks.columnToday': 'Hoje',
    'tasks.columnUpcoming': 'Futuras',
    'tasks.noTasksInColumn': 'Nenhuma tarefa nesta coluna',
    ...
    'tasks.deleteConfirm': 'Tem certeza que deseja excluir esta tarefa?',
    'tasks.showCompleted': 'Mostrar concluídas',
    'tasks.columnCompleted': 'Concluídas',
    'tasks.completeTask': 'Concluir tarefa',
    'tasks.completionNotes': 'Descrição da conclusão',
    'tasks.completionNotesRequired': 'Descreva como a tarefa foi concluída',
    'tasks.postpone': 'Adiar',
    'tasks.postponeReason': 'Motivo do adiamento (opcional)',
    'tasks.newDueDate': 'Nova data de vencimento',
    'tasks.viewDetails': 'Ver detalhes',
    'tasks.searchPlaceholderGeneric': 'Buscar...',
    'tasks.filterByContact': 'Mostrando oportunidades de',
    'tasks.clearFilter': 'Limpar filtro',
    'tasks.noResults': 'Nenhum resultado',
    ...
    'profile.passwordHint': 'Use ao menos 8 caracteres, com letras e números.',
    'profile.passwordMismatch': 'As senhas não conferem',
    'profile.passwordTooShort': 'A senha deve ter ao menos 8 caracteres',
    'profile.passwordUpdated': 'Senha alterada',
    'profile.passwordUpdatedDesc': 'Sua senha foi atualizada com sucesso',
  ...
  'en-US': {
    ...
    'dashboard.entered': 'Created',
    'dashboard.closed': 'Won',
    ...
    'tasks.typeFolderCreation': 'Folder creation',
    'tasks.typeInitial': 'Initial',
    'tasks.typeCorrection': 'Correction',
    'tasks.typeDistribution': 'Distribution',
    'tasks.typeCall': 'Call',
    'tasks.typeMessage': 'Message',
    'tasks.typeReminder': 'Reminder',
    'tasks.typeFollowUp': 'Follow-up',
    'tasks.viewList': 'List',
    'tasks.viewKanban': 'Kanban',
    'tasks.columnOverdue': 'Overdue',
    'tasks.columnToday': 'Today',
    'tasks.columnUpcoming': 'Upcoming',
    ...
    'tasks.columnCompleted': 'Completed',
    'tasks.completeTask': 'Complete task',
    'tasks.completionNotes': 'Completion notes',
    'tasks.completionNotesRequired': 'Describe how the task was completed',
    'tasks.postpone': 'Postpone',
    'tasks.postponeReason': 'Postpone reason (optional)',
    'tasks.newDueDate': 'New due date',
    'tasks.viewDetails': 'View details',
    'tasks.searchPlaceholderGeneric': 'Search...',
    'tasks.filterByContact': 'Showing opportunities for',
    ...
    'profile.passwordHint': 'Use at least 8 characters, with letters and numbers.',
    'profile.passwordMismatch': 'Passwords do not match',
    'profile.passwordTooShort': 'Password must be at least 8 characters',
    'profile.passwordUpdated': 'Password changed',
    'profile.passwordUpdatedDesc': 'Your password was updated successfully',
    'profile.avatar': 'Avatar',
