...
import { EnvelopeSimple, Phone, Buildings, PencilSimple, TrashSimple, DotsThreeVertical, User, FileText, MapPin, Calendar, Megaphone, ArrowSquareOut, CaretLeft } from '@phosphor-icons/react';
