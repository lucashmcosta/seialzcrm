-- ROLLBACK Fase 2. Remove document_rules e restaura o evaluator original (sem checagem de documentos).
begin;
...
alter table public.opportunity_close_policies drop column if exists document_rules;
